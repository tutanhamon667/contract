...
Онлайн-сервис доступен по адресу https://taski.ddns.net 
API: [https://taski.ddns.net/api/](https://taski.ddns.net/api/)

Документация: 
Redoc: [https://taski.ddns.net/redoc/](https://taski.ddns.net/redoc/)
