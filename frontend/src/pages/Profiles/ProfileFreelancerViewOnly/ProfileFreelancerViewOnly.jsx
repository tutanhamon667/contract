          ...
          <div className="profile_block profile__left-column-info">
            ...
            <div>
              ...
              <p className="profile__main-text profile__info-main-text">
                HTML, CSS, JavaScript, Figma, MongoDB
              </p>
            </div>
            <div>
        ...
        <div className="profile_block profile_right-column">
          <div className="form-profile__input-container">
            ...
            <p className="profile__main-text">
              Я - дизайнер с огромным опытом и страстью к творчеству. Моя работа - это создание
              уникальных и стильных дизайн-проектов, которые придают пространству характер и уют.
              Моя цель - не просто удовлетворить ваши ожидания, но и превзойти их, чтобы ваш дом
              стал истинным отражением вашей индивидуальности. Давайте вместе сделаем ваш интерьер
              неповторимым! Я также стремлюсь к тому, чтобы мой дизайн не только выглядел прекрасно,
              но и был функциональным, учитывая ваши потребности и образ жизни. Мой подход к работе
              основан на внимательном прослушивании ваших пожеланий и вдохновении вашей уникальной
              историей. Вместе мы создадим пространство, которое будет радовать вас каждый день и
