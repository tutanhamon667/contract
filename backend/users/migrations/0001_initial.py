    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('activity', models.ManyToManyField(to='users.activity', verbose_name='Специализация')),
            ],
        ),
        migrations.CreateModel(
            name='Skil',
        ...
        migrations.AddField(
            model_name='profile',
            name='skil',
            field=models.ManyToManyField(to='users.skil', verbose_name='Навык'),
        ),
        migrations.AddField(
            model_name='activity',
            name='skils',
            field=models.ManyToManyField(blank=True, to='users.skil', verbose_name='Необходимый навык'),
        ),
    ]
